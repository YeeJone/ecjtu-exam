...
<script type="text/javascript">
   $('#example').removeClass( 'display' ).addClass('table table-sthiped table-bordered');
    ...
    function initTable(){
        ...
        "ajax":{
            "type":"POST",
            "url":"<?php echo site_url('student/stutask/getTask/'.$studentname.'');?>",
        ...
        "columns":[
            ...
            },
            {
                ...
                "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                    if(sData.status == 2){
                        $(nTd).html("<a href='<?php echo site_url('student/stutask/goTask/');?>"+sData.taskid+"/"+sData.studentname+"'>进入任务</a>");
                    }else if(sData.status == 0){
                        $(nTd).html("<a href='<?php echo site_url('student/stutask/goTask/');?>"+sData.taskid+"/"+sData.studentname+"'>继续任务</a>");
                    }else{
                        $(nTd).html("已完成");
                    }
                }
