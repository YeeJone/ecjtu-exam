...
<script type="text/javascript">
   $('#example').removeClass( 'display' ).addClass('table table-sthiped table-bordered');
    ...
    function initTable(){
        ...
        "ajax":{
            "type":"POST",
            "url":"<?php echo site_url('student/stuscore/getExamScore/'.$studentname.'');?>",
        ...
        "columns":[
            ...
            },
            {
                ...
                "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {  
                        $(nTd).html("<a href='<?php echo site_url('student/stuscore/examDetail/'.$studentname.'/1/');?>"+sData+"'>详细查看</a>");
                }
            },
        ]
