...
<html>
<head>
	<title>generate task test</title>
	<meta charset="utf-8">
...
<body>
    <div class="container">
    	<p class="title">生成自主学习试卷</p>
        <div class="testName">
            <label>组卷名称(自己命名): </label>
    ...
    $('#submit').on('click',function(){
        ...
        if(testNameVal == ''){
            ...
            if (allVal == '') { 
                ...
                $.ajax({
                	url:'<?php echo site_url('student/stuself/assemblykMade');?>',
                	type:"post",
                	data:{
                        name:testNameVal,
                		val:allVal,
                	...
                	success:function(data){
                         if(data==1){
                         	alert("提交成功！");
                            window.location.href = "<?php echo site_url('student/stuself/assemblyList/'.$studentname.'');?>";
                         }else{
                         	alert("提交失败！");
    ...
    function initTable(id){
        ...
        "ajax":{
            "type":"post",
            "url":"<?php echo site_url('student/stuself/searchAssemby');?>",
            "data":{
                id:id,
            },
            // success:function(data)
