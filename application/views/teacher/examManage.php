...
<script type="text/javascript">
    ...
    function initTable(){
        ...
        "ajax":{
            "type":"POST",
            "url":"<?php echo site_url('teacher/techexam/examManage');?>",
        ...
        "columns":[
            ...
            },
            {
                ...
                "fnCreatedCell":function(nTd,sData,oData,iRow,iCol){
                    if(sData==1){
                        $(nTd).html("<p class='t_active' data-is='1' t_id=" + oData.E_id + ">已开放</p>").append("<button type='button' class='btn btn-default activebtn' onclick='activeFun(this)'>取消开放</button>");
                    }else{
                        $(nTd).html("<p class='t_active' data-is='0' t_id=" + oData.E_id + ">未开放</p>").append("<button type='button' class='btn btn-default activebtn' onclick='activeFun(this)'>开放</button>");
                    }
                }
            },
            {
    ...
    function activeFun(obj) {
        ...
        $.ajax({
            type:"post",
            url:"<?php echo site_url('teacher/techexam/updateStatus');?>",//php
            data:{
                'id':t_id,
                'data_is':data_is
            },
