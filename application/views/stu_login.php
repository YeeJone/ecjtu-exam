	...
	<body>
		<div class="index-box">
			...
			<div class="index-body">
				...
				<div class="change">
					...
					<div class="registered-box">
						<div class="wrap">
							...
							<div class="password">
								<input type="password" id="passwor" name="" minlength="6" value="" placeholder="密码(不少于6位)">
								<label class="error passwor" >请输入密码</label>
							</div>
							<div class="password">
								<input type="password" id="pd_again" name="" minlength="6" value="" placeholder="再次输入密码">
								<label class="error pd_again" >请再次输入密码</label>
							</div>
							<div class="password">
								<div class="sex"><input type="radio" id="man" name="sex" value="男" />男
								<input type="radio" id="woman" name="sex" value="女" />女</div>
								<label class="error a_sex" >请选择性别</label>
							</div>
							<div class="password">
								...
								<label class="error school" >请选择学校</label>
							</div>
							<div class="password">
								...
								<label class="error class" >请选择班级</label>
							</div>
							<div class="password">
								<input type="text" id="code" name="" maxlength="4" value="" placeholder="验证码">
								<label class="error code">请输入验证码</label>
				...
				<!--注册结束-->
				<!--登录开始-->
				<?php echo form_open('login/studentCheck');?>
					<div class="login-box">
						<div class="wrap">
							<div class="phone">
